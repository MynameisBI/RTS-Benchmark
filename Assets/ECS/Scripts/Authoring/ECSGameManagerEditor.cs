...
[CustomEditor(typeof(ECSGameManagerAuthoring))]
public class ECSGameManagerAuthoringEditor : Editor
{
    string[] mapFiles;
    ...
    public override void OnInspectorGUI()
    {
        ...
        ECSGameManagerAuthoring gameManager = (ECSGameManagerAuthoring)target;
